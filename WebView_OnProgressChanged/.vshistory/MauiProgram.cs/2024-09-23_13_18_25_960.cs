...
public static class MauiProgram
{
    ...
    {
        handlers.AddCompatibilityRenderer(typeof(SharedCustomWebViewRenderer), typeof(SharedCustomWebViewRenderer));
        handlers.AddHandler(typeof(SharedCustomWebViewHandler), typeof(SharedCustomWebViewHandler));
    }
}
